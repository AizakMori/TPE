...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-2 my-0 bg-light border-top">
    ...
    <a href="home/all" class="col-md-4 d-flex align-items-center justify-content-center mb-2 mb-md-0 me-md-auto link-dark text-decoration-none"> Detalle de todos!!</a>
    <ul class="nav col-md-4 justify-content-end">
      <li class="nav-item"><a href="home" class="nav-link px-4 text-muted">Home</a></li>
      <li class="nav-item"><a href="login" class="nav-link px-4 text-muted">Log in</a></li>
    </ul>
  </footer>
